...
/***/ function(module, exports, __webpack_require__) {
	...
	var Login = function (_Component) {
	  ...
	  _createClass(Login, [{
	    ...
	    key: 'authenticating',
	    value: function authenticating() {
	      var authenticating;
	      if (this.props.login.frontend.authenticating) {
	        authenticating = _react2.default.createElement(
	          'div',
	          null,
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.handleLogout = exports.handleLogin = undefined;
	exports.loginSuccess = loginSuccess;
	exports.userInfo = userInfo;
	exports.fetchUserInfo = fetchUserInfo;
	exports.list_video = list_video;
	exports.paginate_video = paginate_video;
	exports.minimumPhotoError = minimumPhotoError;
	exports.begin_project = begin_project;
	exports.set_music = set_music;
	exports.add_photos = add_photos;
	exports.save_video = save_video;
	exports.render_video = render_video;
	exports.get_rendered_video = get_rendered_video;
	exports.check_rendered_video = check_rendered_video;
	exports.reset_vdd = reset_vdd;
	...
	function loginSuccess(response) {
	  return { response: response, type: types.LOGIN };
	}

	function userInfo(response) {
	  return { response: response, type: types.USER_INFO };
	}
	...
	function minimumPhotoError() {
	  return { type: types.FE_MINIMUM_PHOTO_ERROR };
	}

	function begin_project(data) {
	  return function (dispatch, getState) {
	    var pv_headers = getState().picovico.headers;
	    return dispatch((0, _api2.default)({ url: urls.BEGIN_PROJECT, method: "POST", data: data, headers: pv_headers })).then(function (response) {
	      return response.json();
	    }).then(function (response) {
	      dispatch({ response: response, type: types.BEGIN_PROJECT });
	      return response;
	    });
	  };
	}
	...
	function set_music() {
	  return function (dispatch, getState) {
	    ...
	    return dispatch((0, _api2.default)({ url: urls.ADD_MUSIC, method: "POST", data: music_data, headers: pv_headers })).then(function (response) {
	      return response.json();
	    }).then(function (response) {
	      ...
	      return dispatch({ music_asset_data: music_asset_data, type: types.SET_MUSIC });
	    });
	  };
	}
	...
	function add_photos(data) {
	  ...
	  return function (dispatch, getState) {
	    ...
	    for (var i in limited_photo_data) {
	      ...
	      allPromises[i] = dispatch((0, _api2.default)({ url: urls.ADD_PHOTO, method: "POST", data: data, headers: pv_headers })).then(function (response) {
	        return response.json();
	      }).then(function (response) {
	...
	function save_video() {
	  return function (dispatch, getState) {
	    ...
	    return dispatch((0, _api2.default)({ url: 'me/videos/' + video_id, method: "POST", data: vdd, headers: pv_headers })).then(function (response) {
	      return response.json();
	    }).then(function (response) {
	      return response;
	    });
	...
	function create_video(id, router) {
	  return function (dispatch, getState) {

	    var pv_headers = getState().picovico.headers;
	    var album = getState().picovico.user_info.albums.data.filter(function (album) {
	      return album.id == id;
	    });
	    ...
	    if (album[0].photos.data.length < 4) {
	      ...
	      var photo_data = album[0].photos.data.filter(function (photo) {
	        return photo.source;
	      }).map(function (album) {
	        return album.source;
	      });
	...
	function album_selection_error() {
	  return function (dispatch) {
...
/***/ function(module, exports) {
	...
	var LOGIN = exports.LOGIN = "FB_LOGIN";
	var USER_INFO = exports.USER_INFO = "USER_INFO";
	var USER_PHOTO = exports.USER_PHOTO = "USER_PHOTO";
	var VIDEOS = exports.VIDEOS = "VIDEOS";
	var BEGIN_PROJECT = exports.BEGIN_PROJECT = "BEGIN_PROJECT";
	var CREATE_VIDEO = exports.CREATE_VIDEO = "CREATE_VIDEO";
	var SET_STYLE = exports.SET_STYLE = "SET_STYLE";
	var ADD_PHOTO = exports.ADD_PHOTO = "ADD_PHOTO";
	var SET_MUSIC = exports.SET_MUSIC = "SET_MUSIC";
	var RESET_VDD = exports.RESET_VDD = "RESET_VDD";

	var FE_AUTHENTICATING = exports.FE_AUTHENTICATING = "FE_AUTHENTICATING";
	var FE_COMPLETE_AUTHENTICATING = exports.FE_COMPLETE_AUTHENTICATING = "FE_COMPLETE_AUTHENTICATING";
	var FE_LOGIN_ERROR = exports.FE_LOGIN_ERROR = "FE_LOGIN_ERROR";
	var FE_EMAIL_NOT_FOUND_ERROR = exports.FE_EMAIL_NOT_FOUND_ERROR = "FE_EMAIL_NOT_FOUND_ERROR";
	var FE_ALBUM_SELECTION_ERROR = exports.FE_ALBUM_SELECTION_ERROR = "FE_ALBUM_SELECTION_ERROR";
	var FE_MINIMUM_PHOTO_ERROR = exports.FE_MINIMUM_PHOTO_ERROR = "FE_MINIMUM_PHOTO_ERROR";
	var FE_CREATING_VIDEO = exports.FE_CREATING_VIDEO = "FE_CREATING_VIDEO";
...
/***/ function(module, exports) {
	...
	var EMAIL_NOT_FOUND = exports.EMAIL_NOT_FOUND = "Sorry, email was not received from facebook. We could not proceed further";
	var PHOTO_NOT_AVAILABLE = exports.PHOTO_NOT_AVAILABLE = "Sorry, your photo was not available from facebook. We are unable to make your video";
	var ALBUM_SELECTION_ERROR = exports.ALBUM_SELECTION_ERROR = "Please, select an album to create a video.";
	var MINIMUM_PHOTO_ERROR = exports.MINIMUM_PHOTO_ERROR = "A video needs atleast four(4) photos. Please select an album having four(4) photos";
...
/***/ function(module, exports, __webpack_require__) {
	...
	function picovicoApi() {
		...
		return function (dispatch, getState) {
			...
			return (0, _isomorphicFetch2.default)(urls.PICOVICO_API_ENDPOINT + url, init_params);
		};
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reduxRouter = __webpack_require__(196);

	var _reduxThunk = __webpack_require__(255);

	var _reduxThunk2 = _interopRequireDefault(_reduxThunk);

	var _createBrowserHistory = __webpack_require__(256);
	...
	var createStoreWithMiddleware = (0, _redux.compose)((0, _redux.applyMiddleware)(_reduxThunk2.default), (0, _reduxRouter.reduxReactRouter)({ routes: _routes2.default, createHistory: _createBrowserHistory2.default }))(_redux.createStore);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _routerStateReducer2 = __webpack_require__(197);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _routerStateEquals = __webpack_require__(246);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Link2 = __webpack_require__(234);

	var _Link3 = _interopRequireDefault(_Link2);

	exports.Link = _Link3['default'];

	var _IndexLink2 = __webpack_require__(235);
	...
	var _PropTypes2 = __webpack_require__(233);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _historyLibCreateHashHistory = __webpack_require__(203);

	var _historyLibCreateHashHistory2 = _interopRequireDefault(_historyLibCreateHashHistory);

	var _RouteUtils = __webpack_require__(219);

	var _RoutingContext = __webpack_require__(220);

	var _RoutingContext2 = _interopRequireDefault(_RoutingContext);

	var _useRoutes = __webpack_require__(223);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _parsePath = __webpack_require__(215);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _deprecate = __webpack_require__(218);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _extractPath = __webpack_require__(216);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _historyLibUseQueries = __webpack_require__(224);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _historyLibCreateMemoryHistory = __webpack_require__(244);

	var _historyLibCreateMemoryHistory2 = _interopRequireDefault(_historyLibCreateMemoryHistory);

	var _historyLibUseBasename = __webpack_require__(245);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reduxReactRouter = __webpack_require__(249);

	var _reduxReactRouter2 = _interopRequireDefault(_reduxReactRouter);

	var _useDefaults = __webpack_require__(251);

	var _useDefaults2 = _interopRequireDefault(_useDefaults);

	var _routeReplacement = __webpack_require__(252);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _historyMiddleware = __webpack_require__(250);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _replaceRoutesMiddleware = __webpack_require__(253);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactRouterLibIsActive = __webpack_require__(230);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Header = function (_Component) {
	  ...
	  function Header(props) {
	    ...
	    _this.state = { 'activeClassKey': 'videos' };
	    return _this;
	  }

	  _createClass(Header, [{
	    key: 'handleClick',
	    value: function handleClick(activeClassKey) {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement('img', { className: "img-responsive center-block", src: "static/img/picovico.png" })
	          ),
	          _react2.default.createElement(
	            'ul',
	  ...
	  _createClass(List, [{
	    ...
	    value: function render() {
	      ...
	      if (videos.user_videos && videos.user_videos.videos.length > 0) {
	        video_list = videos.user_videos.videos.filter(function (video) {
	          return video.video;
	        }).map(function (video) {
	          return _react2.default.createElement(
	            "div",
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              "a",
	              { onClick: this.paginate.bind(this, paging.prev_url) },
	              "Previous"
	            )
	          ),
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              "a",
	              { onClick: this.paginate.bind(this, paging.next_url) },
	              "Next"
	            )
	          )
	        )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var VideoCreate = function (_Component) {
	  _inherits(VideoCreate, _Component);

	  function VideoCreate(props) {
	    _classCallCheck(this, VideoCreate);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(VideoCreate).call(this, props));

	    _this.state = { 'selected_album': null };
	    return _this;
	  }
	  ...
	  _createClass(VideoCreate, [{
	    ...
	    key: 'album_selection_error',
	    value: function album_selection_error() {
	      var selection_error;
	      if (this.props.albums.frontend.album_selection_error) {
	        selection_error = _react2.default.createElement(
	          'p',
	          null,
	          message.ALBUM_SELECTION_ERROR
	        );
	        return selection_error;
	      }
	    }
	  }, {
	    key: 'minimum_photo_error',
	    value: function minimum_photo_error() {
	      var photo_error;
	      if (this.props.albums.frontend.minimum_photo_error) {
	        photo_error = _react2.default.createElement(
	          'div',
	          { className: "container" },
	          _react2.default.createElement(
	            'div',
	...
	exports.default = VideoCreate;


	VideoCreate.propTypes = {
	  albums: _react.PropTypes.object,
	  actions: _react.PropTypes.object.isRequired
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Create = function (_Component) {
	  ...
	  _createClass(Create, [{
	    ...
	    value: function handleClick() {
	      var _props = this.props;
	      var selected_album = _props.selected_album;
	      var actions = _props.actions;
	      var history = _props.history;
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                  'button',
	                  { type: 'button', className: "btn btn-default", onClick: this.handleClick.bind(this) },
	                  'Create Video'
	                )
	              )
	            )
	  ...
	  _createClass(AlbumList, [{
	    ...
	    value: function render() {
	      ...
	      if (albums.user_info) {
	        ...
	        album_list = albums.user_info.albums.data.filter(function (album) {
	          return album.photos;
	        }).map(function (album) {
	          return _react2.default.createElement(
	            'div',
